...
import { getToolsAgentProperties } from './description';
...
export class DatabricksAiAgent implements INodeType {
	description: INodeTypeDescription = {
		...
		icon: { light: 'file:DatabricksAiAgentLight.icon.svg', dark: 'file:DatabricksAiAgentDark.icon.svg' },
		group: ['transform'],
		description: 'Databricks AI Agent with MLflow tracking. Generates an action plan and executes it. Can use external tools.',
		defaults: {
